      ...
      >
        {slides.map((slide) => (
          <SwiperSlide key={slide.id}>
            <div className="relative w-full h-[600px] md:h-[700px] mx-auto">
              {" "}
              ...
              <div className="container mx-auto relative h-full flex items-center px-6">
                <div className="max-w-4xl">
                  ...
                  <a
                    href={slide.ctaLink}
                    className="inline-block bg-white text-black font-semibold px-8 py-3 rounded-full hover:bg-gray-200 transition-all duration-300 animate-fadeInUp delay-200"
                  >
                    {slide.ctaText}
                  </a>
                </div>
