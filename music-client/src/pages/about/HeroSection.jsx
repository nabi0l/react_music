      ...
      <div className="relative z-10 flex h-full items-center justify-center text-center px-5">
        ...
        >
          ...
          >
            ...
            <a
              href="#"
              className="px-6 py-3 border-2 border-white text-white rounded-full font-semibold uppercase tracking-wider hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 text-sm md:text-base"
            >
              Join Our Community
            </a>
          </motion.div>
